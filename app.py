...
st.caption(
    "Envie os relatórios exportados do Portal do Parceiro para obter a "
    "previsão de quanto produzir de cada item em cada dia da semana."
)
...
with aba1:
    ...
    dia_escolhido = st.selectbox("Ver lista de produção de um dia específico", colunas_dia)
